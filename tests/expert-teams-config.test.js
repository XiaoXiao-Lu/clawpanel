...
test('Expert Teams page supports expert editing and team member selection', () => {
  for (const token of [
    ...
    'shouldDeferSkillsEditorRefresh(page, state)',
  ...
  assert.match(page, /function shouldDeferSkillsEditorRefresh\(page,\s*state\)/)
  assert.match(page, /form\.contains\(document\.activeElement\)/)
...
test('Expert Teams browser smoke guards deleted expert pruning teams', () => {
  for (const token of [
    ...
    'checkGroupTemplatePickerCancelKeepsDraft',
    'Template picker stayed open after backdrop cancel',
    'Template picker cancel changed editor state',
    'groupEditorSnapshot',
    'templateCancel',
    'Template picker rendered',
    'Template picker stayed open after selecting template',
    'expectedTemplates',
    "mode: 'sequential'",
    'did not apply a localized team name',
    'wrote unexpected workflow limits',
    'templateDraft',
    'checkTemplateTeamSavePersists',
    'smoke-template-product',
    'Saved template team was not returned by the API after reload',
    'Saved template team limits changed',
    'Reloaded template team UI values changed',
    'templatePersistence',
    'checkModeratorClearsWhenMemberRemoved',
    'smoke-moderator-sync',
    'Moderator choices did not refresh after member removal',
    'Removed member stayed as saved moderator',
    'moderatorMemberSync',
    'checkMemberDragOrderPersists',
    'smoke-order-sync',
    'selectedMemberRows',
    'Dragged member order was not persisted',
    'memberOrderDrag',
    'checkEmptyTeamSaveIsBlocked',
    'smoke-empty-team',
    'Empty expert team attempted to call save_expert_group',
    'Empty expert team was persisted despite validation failure',
    'emptyTeamValidation',
    'checkInvalidTeamIdSaveIsBlocked',
    'smoke invalid/team',
    'Invalid expert team attempted to call save_expert_group',
    'Invalid expert team ID was persisted despite validation failure',
    'invalidTeamIdValidation',
    'checkInvalidExpertModelSaveIsBlocked',
    'smoke-invalid-model-ref',
    'Invalid expert fixed model attempted to call save_expert',
    'Invalid expert fixed model was persisted despite validation failure',
    'invalidExpertModelValidation',
    'checkInvalidExpertIdSaveIsBlocked',
    'smoke invalid/expert',
    'Invalid expert ID attempted to call save_expert',
    'Invalid expert ID was persisted despite validation failure',
    'invalidExpertIdValidation',
    'checkExpertSaveFailurePreservesDraft',
    'smoke-save-failure',
    'Smoke forced save_expert failure',
    'consumeExpectedConsoleError',
    'Failed expert save was persisted despite a server error',
    'Failed expert save changed the dirty draft unexpectedly',
    'expertSaveFailureDraft',
    'page.unroute(routePattern, failSaveExpert)',
    'checkTeamSaveFailurePreservesDraft',
    'smoke-group-save-failure',
    'Smoke forced save_expert_group failure',
    'Failed expert team save was persisted despite a server error',
    ...
    'checkTeamDeleteFailurePreservesState',
    'Smoke forced delete_expert_group failure',
    'Failed expert team delete removed smoke team despite a server error',
    'Failed expert team delete changed moderator unexpectedly',
    'Failed expert team delete changed members unexpectedly',
    'Failed expert team delete changed the selected team unexpectedly',
    'teamDeleteFailureState',
    'page.unroute(routePattern, failDeleteExpertGroup)',
