...
test('custom desktop titlebar reserves stable app height', () => {
  ...
  assert.match(cssBlock(layoutCss, 'body.has-desktop-chrome .desktop-titlebar'), /height:\s*36px/)
  assert.match(cssBlock(layoutCss, 'body.has-desktop-chrome .desktop-titlebar'), /z-index:\s*100000/)
