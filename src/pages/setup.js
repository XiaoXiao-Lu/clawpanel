  ...
  if (!nodeOk) {
    html += `
      <div class="config-section setup-step-section">
        ...
        <p class="setup-step-desc">${t('setup.stepNodeHint')}</p>
        ...
        <div class="setup-step-box">
          ...
          <div class="setup-input-row setup-input-row--tight">
            <input id="input-node-path" type="text" placeholder="${isMacPlatform() ? '/usr/local/bin' : 'F:\\AI\\Node'}" class="setup-input-compact">
