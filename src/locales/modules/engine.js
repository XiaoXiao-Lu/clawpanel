...
export default {
  ...
  hermesModelConfigTemperature: _('温度（可选）', 'Temperature (optional)', '溫度（可選）'),
  hermesModelConfigTopP: _('Top-p（可选）', 'Top-p (optional)', 'Top-p（可選）'),
  hermesModelConfigTopK: _('Top-k（可选）', 'Top-k (optional)', 'Top-k（可選）'),
