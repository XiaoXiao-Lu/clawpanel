...
export default {
  ...
  // 办公室监控
  officeTitle: _('办公室监控', 'Office Monitor', '辦公室監控'),
  officeLegendIdle: _('空闲', 'Idle', '空閒'),
  officeLegendWorking: _('工作中', 'Working'),
  officeLegendBlocked: _('阻塞', 'Blocked', '阻塞'),
  officeLegendError: _('异常', 'Error', '異常'),
  officeViewLabel: _('办公室视角', 'Office View', '辦公室視角'),
  officeViewOverview: _('全景', 'Overview', '全景'),
  officeViewWork: _('工位', 'Workstations', '工位'),
  officeViewLounge: _('休息区', 'Lounge', '休息區'),
  officeFocus: _('专注视图', 'Focus View', '專注視圖'),
  officeFocusExit: _('退出专注', 'Exit Focus', '退出專注'),
  officeDemo: _('演示动态', 'Demo', '演示動態'),
  officeDemoClose: _('关闭演示', 'Close Demo', '關閉演示'),
  officeStress: _('压测', 'Stress Test', '壓測'),
  officeStressStart: _('开始压测', 'Start Stress Test', '開始壓測'),
  officeStressEnd: _('关闭压测', 'Stop Stress Test', '關閉壓測'),
  officeStressDesc: _('开发压测只影响当前 3D 可视化，不会写入 Agent 配置', 'Stress test only affects current 3D visualization, not Agent config', '開發壓測只影響當前 3D 可視化，不會寫入 Agent 設定'),
  officeStressLabel: _('压测 Agent 数量', 'Number of stress test agents', '壓測 Agent 數量'),
  officeLoading: _('办公室加载中', 'Office Loading', '辦公室載入中'),
  officeLoadingDesc: _('正在准备 3D Agent 办公室视图。', 'Preparing 3D Agent office view.', '正在準備 3D Agent 辦公室視圖。'),
  officeLoadFailed: _('办公室加载失败', 'Office Load Failed', '辦公室載入失敗'),
  officeFallbackDesc: _('3D 办公室初始化失败，已切换到低负载状态板。', '3D office initialization failed, switched to low-load status panel.', '3D 辦公室初始化失敗，已切換到低負載狀態板。'),
  officeDataStress: _('压测数据', 'Stress Test Data', '壓測數據'),
  officeDataDemo: _('演示数据', 'Demo Data', '演示數據'),
  officeDataReal: _('真实', 'Live', '真實'),
  officeFlowError: _('活动流异常', 'Activity Flow Error', '活動流異常'),
  stateIdle: _('空闲', 'Idle', '空閒'),
  stateWorking: _('工作中', 'Working'),
  stateBlocked: _('阻塞', 'Blocked', '阻塞'),
  stateError: _('异常', 'Error', '異常'),
  progressIdle: _('休息区待命', 'Idle at Lounge', '休息區待命'),
  progressWalking: _('走向工位', 'Walking to Workstation', '走向工位'),
  progressBlocked: _('需要检查输入或权限', 'Needs input or permission check', '需要檢查輸入或權限'),
  progressDemo: _('演示动态，不影响真实任务', 'Demo, does not affect real tasks', '演示動態，不影響真實任務'),
}
