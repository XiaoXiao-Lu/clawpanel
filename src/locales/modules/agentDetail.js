...
export default {
  ...
  selectAllSkills: _('全选可用', 'Select All Available'),
  clearSkills: _('清空选择', 'Clear Selection'),
  skillsSelectedCount: _('已选择 {selected} / {total} 个可用技能', '{selected} / {total} available skills selected'),
