...
export default {
  ...
  storeSourceHint: _('搜索使用 SkillHub 远端源；精选列表优先使用高速镜像。', 'Search uses the remote SkillHub source; featured listings prefer the fast mirror.', '搜尋使用 SkillHub 遠端源；精選列表優先使用高速鏡像。'),
