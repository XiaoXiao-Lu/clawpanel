...
export default {
  ...
  sourceUrl: _('来源网址', 'Source URL', '來源網址'),
  ...
  storeTitle: _('SkillHub 技能市场', 'SkillHub marketplace', 'SkillHub 技能市場'),
  storeSubtitle: _('从 SkillHub 搜索社区技能，先预览用途与依赖，再一键安装。', 'Search community skills from SkillHub, preview usage and requirements, then install in one click.', '從 SkillHub 搜尋社群技能，先預覽用途與依賴，再一鍵安裝。'),
  featured: _('精选', 'Featured', '精選'),
  featuredMeta: _('精选 {count} 个 SkillHub 技能', '{count} featured SkillHub skills', '精選 {count} 個 SkillHub 技能'),
  searchMeta: _('找到 {count} 个与「{query}」相关的 Skill', '{count} skills found for "{query}"', '找到 {count} 個與「{query}」相關的 Skill'),
  storeSourceHint: _('默认聚合 SkillHub + 虾评 + GitHub 三源搜索，可切换单一来源。', 'Aggregates SkillHub + Xiaping + GitHub by default; switch to a single source if needed.', '預設聚合 SkillHub + 蝦評 + GitHub 三源搜尋，可切換單一來源。'),
  preview: _('预览', 'Preview', '預覽'),
  previewEmpty: _('选择左侧 Skill 查看用途、来源和安装信息。', 'Select a skill on the left to preview usage, source, and install details.', '選擇左側 Skill 查看用途、來源和安裝資訊。'),
  previewUse: _('用途预览', 'Usage preview', '用途預覽'),
  noDescription: _('暂无描述', 'No description yet', '暫無描述'),
  author: _('作者', 'Author', '作者'),
  downloads: _('下载', 'downloads', '下載'),
  stars: _('星标', 'stars', '星標'),
  tags: _('标签', 'Tags', '標籤'),
  requirements: _('要求', 'Requirements', '要求'),
  openHomepage: _('打开主页', 'Open homepage', '打開主頁'),
  openSourceUrl: _('打开来源', 'Open source', '打開來源'),
  browse: _('浏览', 'Browse', '瀏覽'),
  browseCn: _('打开 SkillHub CN', 'Open SkillHub CN', '打開 SkillHub CN'),
  browseOfficial: _('打开 SkillHub', 'Open SkillHub', '打開 SkillHub'),
  browseMirror: _('查看镜像索引', 'View mirror index', '查看鏡像索引'),
  installZip: _('本地 ZIP 安装', 'Install ZIP', '本地 ZIP 安裝'),
  sourceMirror: _('高速镜像', 'Fast mirror', '高速鏡像'),
  sourceCn: _('SkillHub CN', 'SkillHub CN', 'SkillHub CN'),
  sourceOfficial: _('官方源', 'Official', '官方源'),
  sourceAll: _('全部源', 'All Sources', '全部來源'),
  sourceXiaping: _('虾评', 'Xiaping', '蝦評'),
  sourceHint: _('选择技能搜索源', 'Select skill search source', '選擇技能搜尋源'),
  githubTokenHint: _('GitHub 代码搜索需要认证。请设置 <code>GITHUB_TOKEN</code> 环境变量后重试。', 'GitHub code search requires authentication. Please set the <code>GITHUB_TOKEN</code> environment variable.', 'GitHub 程式碼搜尋需要認證。請設定 <code>GITHUB_TOKEN</code> 環境變數。'),
  zipOnly: _('请选择 .zip 技能包', 'Please choose a .zip skill package', '請選擇 .zip 技能包'),
  zipInstalled: _('Skill {name} 已从 ZIP 安装', 'Skill {name} installed from ZIP', 'Skill {name} 已從 ZIP 安裝'),
