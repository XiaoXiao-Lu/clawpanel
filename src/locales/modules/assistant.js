...
export default {
  ...
  expertTeamManage: _('管理专家与团队...', 'Manage experts & teams...'),
  expertTeamManageDesc: _('前往专家团配置页面', 'Go to expert team configuration'),
  ...
  expertTeamStopTitle: _('停止运行', 'Stop run'),
  expertTeamFollowUpAria: _('专家团追问操作', 'Expert team follow-up actions'),
  expertTeamDeliveredHint: _('团队已完成交付。继续输入将基于此结论追问，或选择下方操作。', 'Team delivery complete. Continue typing to follow up, or choose an action below.'),
  expertTeamFollowUp: _('追问专家团', 'Follow up'),
  expertTeamFollowUpTitle: _('基于交付结论继续追问此专家团', 'Continue asking this team based on the deliverable'),
  expertTeamFollowUpActivated: _('已切换到专家团追问模式，输入问题即可追问', 'Follow-up mode activated; type your question'),
  expertTeamRerun: _('重新执行', 'Re-run'),
  expertTeamRerunTitle: _('用同一个专家团重新处理新任务', 'Re-run with the same team for a new task'),
  expertTeamRerunActivated: _('已切换到专家团模式，输入新任务即可重新执行', 'Expert team mode activated; type a new task to re-run'),
  expertTeamExit: _('回到普通对话', 'Back to chat'),
  expertTeamExitTitle: _('退出专家团模式，回到普通助手对话', 'Exit expert team mode and return to normal chat'),
}
