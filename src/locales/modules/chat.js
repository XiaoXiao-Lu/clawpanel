...
export default {
  ...
  sessionSearchPlaceholder: _('搜索会话、Agent 或会话 Key', 'Search sessions, agents, or keys', '搜尋對話、Agent 或對話 Key'),
  sessionAllAgents: _('全部 Agent', 'All agents', '全部 Agent'),
  sessionSelect: _('选择会话', 'Select session', '選擇對話'),
  sessionPin: _('置顶会话', 'Pin session', '置頂對話'),
  sessionUnpin: _('取消置顶', 'Unpin session', '取消置頂'),
  sessionPinned: _('会话已置顶', 'Session pinned', '對話已置頂'),
  sessionUnpinned: _('已取消置顶', 'Session unpinned', '已取消置頂'),
  sessionSelectedCount: _('已选 {count} 个', '{count} selected', '已選 {count} 個'),
  sessionDeleteSelected: _('删除所选', 'Delete selected', '刪除所選'),
  sessionBulkDeleteTitle: _('批量删除 {count} 个会话', 'Delete {count} sessions', '批量刪除 {count} 個對話'),
  sessionBulkDeleteConfirm: _('确定删除所选 {count} 个会话？', 'Delete the selected {count} sessions?', '確定刪除所選 {count} 個對話？'),
  sessionBulkDeleted: _('已删除 {count} 个会话', 'Deleted {count} sessions', '已刪除 {count} 個對話'),
  sessionBulkDeletePartial: _('已删除 {ok} 个，{fail} 个失败', 'Deleted {ok}, {fail} failed', '已刪除 {ok} 個，{fail} 個失敗'),
  messagesShort: _('{count} 条', '{count} msgs', '{count} 條'),
  messageSearchPlaceholder: _('查找消息', 'Find messages', '查找訊息'),
  messageSearchPrev: _('上一条匹配', 'Previous match', '上一條匹配'),
