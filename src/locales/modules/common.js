...
export default {
  ...
  pageNotFound: _('页面未找到', 'Page not found', '頁面未找到', 'ページが見つかりません', '페이지를 찾을 수 없음', 'Page not found', 'Page not found', 'Page not found', 'Page not found', 'Page not found', 'Page not found'),
  pageNotFoundDesc: _('该路由未注册', 'This route is not registered', '該路由未註冊', 'このルートは登録されていません', '이 경로는 등록되지 않았습니다', 'This route is not registered', 'This route is not registered', 'This route is not registered', 'This route is not registered', 'This route is not registered', 'This route is not registered'),
  backToHome: _('返回首页', 'Back to home', '返回首頁', 'ホームへ戻る', '홈으로 돌아가기', 'Back to home', 'Back to home', 'Back to home', 'Back to home', 'Back to home', 'Back to home'),
