...
async function _loadRouteCSS(routePath) {
  const map = {
    ...
    '/logs': () => import('./style/pages/services.css'),
    '/h/logs': () => import('./style/pages/services.css'),
    '/models': () => import('./style/pages/models.css'),
    '/connectors': () => import('./style/pages/models.css'),
    '/route-map': () => import('./style/pages/route-map.css'),
    '/channels': () => import('./style/pages/channels.css'),
    '/h/channels': () => import('./style/pages/channels.css'),
    '/skills': () => import('./style/pages/settings.css'),
    '/plugin-hub': () => import('./style/pages/plugin-hub.css'),
    '/settings': () => import('./style/pages/settings.css'),
    '/memory': () => import('./style/pages/memory.css'),
    '/memory-auto-capture': () => import('./style/pages/memory-auto-capture.css'),
    '/h/memory': () => import('./style/pages/memory.css'),
    '/notifications': () => import('./style/pages/notifications.css'),
    '/h/gateways': () => import('./style/pages/notifications.css'),
...
const _routeContext = {
  ...
  '/memory-auto-capture': ['sidebar.sectionData', 'sidebar.memoryAutoCapture'],
