...
const PATHS = {
  ...
  'thumbs-up': '<path d="M7 22H4a2 2 0 01-2-2v-7a2 2 0 012-2h3"/><path d="M14 9V5a3 3 0 00-3-3l-4 9v11h11.28a2 2 0 002-1.7l1.38-9a2 2 0 00-2-2.3H14z"/>',
  'thumbs-down': '<path d="M17 2h3a2 2 0 012 2v7a2 2 0 01-2 2h-3"/><path d="M10 15v4a3 3 0 003 3l4-9V2H5.72a2 2 0 00-2 1.7l-1.38 9a2 2 0 002 2.3H10z"/>',
  ...
  'bot': '<path d="M12 8V4H8"/><rect x="4" y="8" width="16" height="12" rx="2"/><path d="M2 14h2"/><path d="M20 14h2"/><path d="M10 13v.01"/><path d="M14 13v.01"/><path d="M10 17c.83.67 1.83 1 3 1s2.17-.33 3-1"/>',
  'puzzle': '<path d="M19.82 2h-5.64a2 2 0 00-2 2v1.56a2 2 0 01-2 2H8.18a2 2 0 01-2-2V4a2 2 0 00-2-2H2.18a2 2 0 00-2 2v5.64a2 2 0 002 2h1.56a2 2 0 012 2v2a2 2 0 01-2 2H2.18a2 2 0 00-2 2v3.36a2 2 0 002 2h3.36c.9 0 1.3-1.04.68-1.65a4 4 0 010-5.66c.62-.61 1.66-.19 1.66.68v3.27a2 2 0 002 2h5.64a2 2 0 002-2v-1.56a2 2 0 012-2h2a2 2 0 012 2V20a2 2 0 002 2h3.36a2 2 0 002-2v-5.64a2 2 0 00-2-2h-1.56a2 2 0 01-2-2v-2a2 2 0 012-2h1.56a2 2 0 002-2V2.18a2 2 0 00-2-2h-3.36a2 2 0 00-2 2v1.56a2 2 0 01-2 2h-2a2 2 0 01-2-2V4a2 2 0 00-2-2z"/>',
  'sparkles': '<path d="M12 3l1.5 5.5L19 10l-5.5 1.5L12 17l-1.5-5.5L5 10l5.5-1.5L12 3z"/><path d="M19 3l.5 2L21.5 5.5 19 6l-.5 2-.5-2L16 5.5 18 5l.5-2zM6.5 17l.3 1.5 1.5.3-1.5.3-.3 1.5-.3-1.5L4.7 19l1.5-.3.3-1.5z"/>',
}
